...
const Step3Report = ({ report }) => {
  ...
  const questionScoreData = questions.map((score, index) => ({
    name: `Q${index + 1}`,
    score: score.score || 0,
  }));
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Execellent clarity and structured responses.";
  } else if (finalScore >= 5) {
    performanceText = "Needs minor improvements before interview.";
    shortTagline = "Good foundation, refine articulation.";
  } else {
    performanceText = "Significant improvement required.";
    shortTagline = "Work on your clarity and confidence";
  }
          ...
          >
            ...
            <div className="h-64 sm:h-72">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={questionScoreData}></AreaChart>
                    ...
                    <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-gray-700 leading-relaxed">
                        {q.feedback && q.feedback.trim() !== ""
                          ? q.feedback
                          : "No feedback avaliable for this question"}
                      </p>
                    </div>
                  </div>
                );
